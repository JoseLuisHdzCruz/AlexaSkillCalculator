...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bienvenidos a calculadora Uthh Jose Luis!!';
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        const speakOutput = 'Lo siento, tuve problemas para hacer lo que me pediste. Por favor, inténtelo de nuevo.';
